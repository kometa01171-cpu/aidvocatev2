...
import { Briefcase, MapPin, Award, Phone, Mail, Loader2, AlertCircle } from "lucide-react"
...
export function LawyersSection() {
  ...
  return (
    <section id="yuristlar" className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-16 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-2 mb-4">
            ...
            <span className="text-sm font-medium text-primary">Bizning Yuristlar</span>
          </div>
          <h2 className="text-4xl sm:text-5xl font-bold text-foreground mb-4">
            Muvaffaqiyatli Advokatlar
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            O'zbekistondagi tajribali juristlardan birini tanlang. Har bir advokat ko'p yillik tajribaga ega va turli huquq sohalari bo'yicha ixtisoslashgan.
          </p>
        </div>
